...
- Name: **معين — Maeen**. Repository/project name: **Maeen**.
...
- On 2026-09-16 the brand was refreshed to **معين — Maeen** across runtime/docs/local design exports. The alpha package was rebuilt and release verification still passed; remote Figma text-node edits require a later Figma MCP/browser session because the Starter quota/session is unavailable.
